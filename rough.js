...
if (fs.existsSync(path)) {
    ...
    (async function example() {
        ...
        /* function to compare the array of urls fetched 
        from logs and the array that's obtained from 
        selectors and returns the urls that are not already in the logs */
